...
for (proj in c("I","OV","I-PC","OV-PC","EFA")){print(proj)
  ...
  for (toothtype in c("LM1","LM2","LM3","UM1","UM2","UM3")){print(toothtype)
    ...
    path <- "./full_shape_classification_SRVF_preserving_size/data/"
    for (i in 1:5){print(i)
      ...
      # if (size){
      # fold_ref_with_size <- read.csv(paste0("/Users/gregorymatthews/Dropbox/full_shape_classification_SRVF_preserving_size/data/folds/",toothtype,"ref_folds_with_size.csv"))
...
#In each slot there is the pred class, real class, and then probs for each tribe.
  save(results_rf_tribe, 
     file = "./full_shape_classification_SRVF_preserving_size/results/results_rf_tribe.rda")

save(results_rf_species, 
     file = "./full_shape_classification_SRVF_preserving_size/results/results_rf_species.rda")

save(results_rf_species_given_tribe, 
file = "./full_shape_classification_SRVF_preserving_size/results/results_rf_species_given_tribe.rda")
