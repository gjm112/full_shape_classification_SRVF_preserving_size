...
save(results_svm_radial_tribe, 
     file = "/Users/gregorymatthews/Dropbox/full_shape_classification_SRVF_preserving_size//results/results_svm_radial_tribe.rda")

save(results_svm_radial_species, 
     file = "/Users/gregorymatthews/Dropbox/full_shape_classification_SRVF_preserving_size//results/results_svm_radial_species.rda")

save(results_svm_radial_species_given_tribe, 
     file = "/Users/gregorymatthews/Dropbox/full_shape_classification_SRVF_preserving_size//results/results_svm_radial_species_given_tribe.rda")
